...
with lcol:
    ...
    with mmcol:
        ...
        st.write('\n')
        st.write('\n')
        st.write('<h1 style="font-family: Aptos, sans-serif; font-size: 24px; font-weight: normal;"><span style="color: rgb(41, 175, 128);">Use transcriptomics data to build temporal networks for <i>Eimeria tenella</i></h1>', unsafe_allow_html=True)
        st.write('<h1 style="font-family: Aptos, sans-serif; font-size: 24px; font-weight: normal;"><span style="color: rgb(41, 175, 128);">Incorporate host-pathogen interactions</h1>', unsafe_allow_html=True)
        st.write('<h1 style="font-family: Aptos, sans-serif; font-size: 24px; font-weight: normal;"><span style="color: rgb(41, 175, 128);">Discard orthologous proteins</h1>', unsafe_allow_html=True)
        st.write('<h1 style="font-family: Aptos, sans-serif; font-size: 24px; font-weight: normal;"><span style="color: rgb(41, 175, 128);">Rank potential drug targets based on connections, lifecycle stages and annotations</h1>', unsafe_allow_html=True)
